...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'stylegan2': dict(ref_gpus=8,  kimg=25000,  mb=32, mbstd=4,  fmaps=1,   lrate=0.002,  gamma=0,   ema=10,  ramp=None, map=8), # Uses mixed-precision, unlike the original StyleGAN2.
    ...
    args.G_kwargs.synthesis_kwargs.channel_base = args.D_kwargs.channel_base = int(spec.fmaps * 16384)
